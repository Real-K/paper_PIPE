# WP13 재실행 사본 (2026-08-26): 정규화 마스터(382 dated)로 동일 코드 재실행. 원본 wp11e_modelaudit.py · 출력 폴더만 pipe_wp13_2026-08-26 으로 치환.
# -*- coding: utf-8 -*-
...
산출: shared/outputs/pipe_wp13_2026-08-26/wp11e.json
"""
