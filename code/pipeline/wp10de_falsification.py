...
산출: shared/outputs/pipe_wp10_2026-08-23/wp10de.json
"""
...
OUT=f"{BASE}/shared/outputs/pipe_wp10_2026-08-23"
...
fdp=pd.read_csv(f"{BASE}/shared/outputs/pipe_wp8_2026-08-23/treatment_fdpp.csv",dtype={"k":str})
