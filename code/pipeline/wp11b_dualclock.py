...
산출: shared/outputs/pipe_wp11_2026-08-23/{funding_dates.csv, wp11b.json}
"""
...
d2=pd.read_csv(f"{BASE}/shared/outputs/pipe_wp9_2026-08-23/wp9e_firm_d_v2.csv",dtype={"k":str})
