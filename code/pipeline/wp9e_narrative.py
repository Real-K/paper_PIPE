...
산출: shared/outputs/pipe_wp9_2026-08-23/wp9e_narrative.json + wp9e_firm_d_v2.csv
"""
...
OUT=f"{BASE}/shared/outputs/pipe_wp9_2026-08-23"
...
# ---------- merge: CAR + 목적 ----------
car=pd.read_csv(f"{BASE}/shared/outputs/pipe_wp8_2026-08-23/wp8b_car_firm.csv",dtype={"k":str})
fd=pd.read_csv(f"{BASE}/shared/outputs/pipe_wp8_2026-08-23/treatment_fdpp.csv",dtype={"k":str})
